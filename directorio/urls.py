...
from directorio.views import (
                                ...
                                milista_dir,
                                un_acuse,
                                seleccionar_acuses_mi_lista,
                                crear_mi_lista,
                                crear_mis_acuses,
                                crear_lista_general,
                                acuses_generales,
                                seleccionar_acuses_directorio,
                            )
...
urlpatterns = [
    ...
    url(r'^generar_acuses_milista/$',seleccionar_acuses_mi_lista, name="acuses_dir"),
    ...
    url(r'^generar_acuses_directorio',seleccionar_acuses_directorio, name = "seleccion_gral_dir"),
]
